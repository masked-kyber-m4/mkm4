...
CFLAGS     += -g -O3 -std=gnu99 \
              ...
              -fno-common $(ARCH_FLAGS) -MD $(DEFINES) -DDETAILBENCHMARK

CC_HOST    = gcc
LD_HOST    = gcc

CFLAGS_HOST = -g -O3 -Wall -Wextra -Wpedantic
LDFLAGS_HOST = -lm

# override as desired
TYPE=kem

COMMONSOURCES=common/fips202.c common/fips202-masked.c common/a2b_singlelookup.c
